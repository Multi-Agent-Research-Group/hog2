  ...
  while(!detectIndependence(solution,group,groups)){
    ...
    for(int j(0); j<G.size(); ++j){
      ...
      if(g.first.size()>1){
        ...
        IDAStar<MAState<Edge>, MultiAgentEnvironment<Edge,tDirection,Map2DConstrainedEnvironment>::MultiAgentAction, MultiAgentEnvironment<Edge,tDirection,Map2DConstrainedEnvironment> > astar;
