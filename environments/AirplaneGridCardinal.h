...
#ifndef AirplaneGridCardinal_h
#define AirplaneGridCardinal_h

#include "Airplane.h"

class AirplaneGridCardinalEnvironment : public AirplaneEnvironment
{
  public:
    AirplaneGridCardinalEnvironment(
        unsigned width=80,
        unsigned length=80,
        unsigned height=20,
    ...
    virtual std::string name()const{static std::string s("AirplaneGridCardinalEnvironment"); return s;}
