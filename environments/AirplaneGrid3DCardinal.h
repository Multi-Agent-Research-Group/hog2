...
#ifndef AirplaneGrid3DCardinal_h
#define AirplaneGrid3DCardinal_h

#include "Airplane.h"

class AirplaneGrid3DCardinalEnvironment : public AirplaneEnvironment
{
  public:
    AirplaneGrid3DCardinalEnvironment(
        unsigned width=80,
        unsigned length=80,
        unsigned height=20,
    ...
    virtual char const*const name()const{return "AirplaneGrid3DCardinalEnvironment";}
    ...
    virtual uint64_t GetStateHash(const airplaneState &node)const{airplaneState a(node);a.heading=a.landed=0;a.speed=3;return AirplaneEnvironment::GetStateHash(a);}
  protected:
    virtual AirplaneEnvironment& getRef() {return *this;}
};

#endif /* AirplaneGrid3DCardinal_h */
