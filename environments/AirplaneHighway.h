...
#ifndef AirplaneHighway_h
#define AirplaneHighway_h

#include "Airplane.h"

class AirplaneHighwayEnvironment : public AirplaneEnvironment
{
public:
	AirplaneHighwayEnvironment(
          unsigned width=80,
          unsigned length=80,
          unsigned height=20,
        ...
        virtual char const*const name()const{return "AirplaneHighway8Environment";}
