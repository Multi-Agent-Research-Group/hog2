...
#ifndef AirplaneGrid3DOctile_h
#define AirplaneGrid3DOctile_h

#include "Airplane.h"

class AirplaneGrid3DOctileEnvironment : public AirplaneEnvironment
{
  public:
    AirplaneGrid3DOctileEnvironment(
        unsigned width=80,
        unsigned length=80,
        unsigned height=20,
    ...
    virtual char const*const name()const{return "AirplaneGrid3DOctileEnvironment";}
