/*
 * $Id: ThetaStar.h,v 1.11 2007/04/05 23:35:42 yngvi Exp $
 *
 *  ThetaStar.h
 *  hog
 *
...
public:
	...
	typedef OpenClosedList<ThetaStarUtil::SearchNode, ThetaStarUtil::SearchNodeHash,
		ThetaStarUtil::SearchNodeEqual, ThetaStarUtil::SearchNodeCompare> PQueue;
	
	typedef __gnu_cxx::hash_map<uint32_t, ThetaStarUtil::SearchNode > NodeLookupTable;
	
	typedef __gnu_cxx::hash_map<uint32_t, bool > Corridor;
}


typedef ThetaStarUtil::NodeLookupTable::const_iterator closedList_iterator;
...
private:
	...
	ThetaStarUtil::PQueue openQueue;
	ThetaStarUtil::NodeLookupTable closedList; //openList
	uint32_t goal, start;

	std::vector<uint32_t> neighbors;
	OldSearchCode::SearchEnvironment *env;
	ThetaStarUtil::Corridor eligibleNodes;
};
